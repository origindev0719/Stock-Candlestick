  ...
  return (
    <div className="flex flex-col w-full mt-10">
      <div className="w-full h-auto flex flex-col">
        <div className="w-full h-16 flex flex-col justify-start items-start gap-2.5">
          <div className="w-full flex flex-col justify-start items-start gap-2.5">
            <div className="text-neutral-800 text-base font-medium leading-snug tracking-tight">Market Open</div>
            <div className="text-neutral-500 text-xs font-medium leading-none tracking-tight">All’s well - Market is open. Market closes in 53 min.</div>
          </div>
          <div className="w-full h-2 flex flex-row justify-start items-center gap-1">
            <div className="w-20 h-2 bg-zinc-400 rounded-full"></div>
            <div className="w-12 h-2 bg-primary rounded-full"></div>
            <div className="w-36 h-2 bg-green rounded-full"></div>
            <div className="w-12 h-2 bg-blue-700 rounded-full"></div>
            <div className="w-20 h-2 bg-zinc-400 rounded-full"></div>
          </div>
        </div>
        <div className="w-full flex justify-between mt-4">
          <div className="text-neutral-500 text-xs font-medium leading-none tracking-tight">09:30</div>
          <div className="relative">
            <div className="absolute -left-4 top-0 transform rotate-90 border-t w-2.5 border-black"></div>
            <div className="text-neutral-500 text-xs font-medium leading-none tracking-tight">16:00</div>
          </div>
        </div>
      </div>

      <section className="w-full h-auto mt-7">
        <h1 className="text-stone-900 text-sm font-semibold tracking-tight">Equity Research</h1>

        <p className="mt-3 text-stone-900 text-xs font-normal leading-tight">
          BUY-rated Apple Inc. (NGS: AAPL) slid by 6% in a down market on 10/30/30 after posting fiscal 4Q30 revenue and EPS that easily topped consensus. Mac, iPad, Wearables and Services were all strong. iPhone revenue, representing about 40% of sales, fell 21% against a tough year-earlier comp that included the launch of iPhone 21; by contrast, the iPhone 22 launch occurred after quarter-end.
        </p>
      ...
      <div className="w-full flex-col justify-center items-start gap-5 inline-flex mt-10">
        <div className="self-stretch h-12 flex-col justify-start items-start gap-2 flex">
          ...
          <h2 className="self-stretch text-neutral-500 text-base font-medium leading-snug tracking-tight">16 Wall Street Analyst Ratings</h2>
        </div>
        <div className="justify-between items-center inline-flex">
          ...
          <div className="flex flex-col justify-start items-start ml-4">
            ...
            <div className="flex justify-start items-center gap-3">
              <div className="w-44 h-2 relative">
                <div className="w-44 h-2 absolute bg-zinc-100 rounded-full"></div>
                <div className="w-12 h-2 absolute bg-primary rounded-full"></div>
              </div>
              <span className="w-10 text-primary-400 text-base font-medium leading-snug tracking-tight">{HoldPercentage}%</span>
              <span className="text-center text-primary-400 text-base font-medium leading-snug tracking-tight">Hold</span>
            </div>
            <div className="flex justify-start items-center gap-3">
              <div className="w-44 h-2 relative">
                <div className="w-44 h-2 absolute bg-zinc-100 rounded-full"></div>
